	...
	return (
		<div className='help-container'>
			<section className='section'>
				<h1 className='title'>Run the App</h1>
			...
			<section className='section'>
				<h1 className='title'>Example of Code Editor</h1>
				<CodeCell cell={exampleCodeCell} />
			</section>
			<section style={{ margin: '0 1.5rem' }}>
				<h1 className='title'>Example of Text Editor</h1>
				<h1 className='title'>Need to click on it to start typing</h1>
